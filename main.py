...
class UsageStatsWidget(QWidget):
    ...
    def __init__(self, adb_device, project_root):
        super().__init__()
        self.device=adb_device
        self.out_dir=os.path.join(project_root, "UsageStats")
...
class DroidForen(QMainWindow):
    def __init__(self):
        ...
        self.SectionList=["Call Logs", "SMS", "WhatsApp", "Photos", "Videos",
    ...
    def open_or_focus_tab(self, item):
        ...
        if title == "Call Logs":
            ...
            # Create the embedded usage stats tab (auto-pulls & shows table)
            usage_widget=UsageStatsWidget(self.device, self.project_root)
    ...
    def export_data(self):
        ...
        try:
            if current_tab == "Photos":
                ...
                src=os.path.join(self.project_root, "UsageStats", "usage_dump.txt")
